...
class MrpProduction(models.Model):
    ...
    def _cw_station_records(self):
        ...
        # The dashboard is configuration-driven: render exactly the active
        # work centers explicitly enabled for the car-wash dashboard.
    ...
    def get_dashboard_data(self):
        ...
        stations = []
        for slot_number, station in enumerate(real_station_payloads, start=1):
            station['slot_number'] = slot_number
        ...
        # Station count and type mix are intentionally dynamic. Administrators
        # control what appears by enabling/disabling real Odoo work centers.
        warnings = []
        ...
        return {
            ...
            'station_configuration': {
                ...
                'target_station_count': len(real_station_payloads),
