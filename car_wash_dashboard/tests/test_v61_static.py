...
class V61ContractTest(unittest.TestCase):
    def test_manifest_version_is_v61(self):
        manifest = ast.literal_eval((ROOT / '__manifest__.py').read_text(encoding='utf-8'))
        self.assertEqual(manifest['version'], '18.0.6.1')
    ...
    def test_concept_vehicle_asset_is_used_for_standard_car_visuals(self):
        for name in ('queue_panel.js', 'station_card.js', 'station_detail.js'):
            ...
            self.assertIn('concept_car.webp', text)
