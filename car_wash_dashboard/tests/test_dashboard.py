...
class TestCarWashDashboard(TransactionCase):
    ...
    def test_payload_has_ten_visual_slots(self):
        ...
        self.assertEqual(payload['dashboard_version'], '6.0-station-concept')
    ...
    def test_pure_station_helpers(self):
        self.assertEqual(normalize_vehicle_size('car'), 'small')
        self.assertEqual(normalize_vehicle_size('truck'), 'large')
